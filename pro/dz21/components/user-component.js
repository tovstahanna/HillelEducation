...
export default class Cards {
        ...
        render(responce) {
            ...
            responce.data.forEach(element => {
                ...
                this._container.insertAdjacentHTML('beforeend', utils.renderTemplate(this._template, element));
        ...
        addNewCard(addTemplate){
            ...
            document.getElementById('add-form').addEventListener('submit', (event) => {
                ...
                const msg = utils.validation(fEmail, fPassword).join("<br>");
                ...
                if (!msg && fEmail && fPassword) {
                    ...
                    this._api.create({
                        ...
                        .then((responce) => {
                            ...
                            this._container.insertAdjacentHTML('afterbegin', utils.renderTemplate(this._template, responce));
        ...
        onEdit(event){
            ...
            editForm.addEventListener('submit', (event) => {
                ...
                console.log(typeof this._api, this._api);
                this._api.edit(update_info)
                    .then(responce => {
